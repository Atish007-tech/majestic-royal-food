...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setToast({ show: true, message: 'Registration Successful! Please Login', type: 'success', duration: 1500 });
    ...
    return (
        <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 0', minHeight: '80vh' }}>
            <div style={{
                ...
                <h1 style={{ fontWeight: 800, marginBottom: '10px', fontSize: '2.5rem', letterSpacing: '-1.5px', color: 'var(--secondary)' }}>Sign Up</h1>
                <p style={{ color: 'var(--text-muted)', marginBottom: '30px', fontWeight: 500 }}>Join the world's best food community.</p>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    <div className="form-group">
                        <label style={{ display: 'block', fontWeight: 700, marginBottom: '10px', fontSize: '0.95rem', color: 'var(--secondary)' }}>Join As</label>
                    ...
                    <div className="form-group">
                        <label style={{ display: 'block', fontWeight: 600, marginBottom: '8px', fontSize: '0.95rem', color: 'var(--text-muted)' }}>Full Name</label>
                        <input
                            type="text"
                    ...
                    >Register as {role}</button>
                </form>
                <p style={{ marginTop: '35px', textAlign: 'center', color: 'var(--text-muted)', fontWeight: 500, fontSize: '0.95rem' }}>
                    Already have an account? <Link to="/login" style={{ color: 'var(--primary)', fontWeight: 700, marginLeft: '5px' }}>Login here</Link>
                </p>
            </div>
            {toast.show && (
                <Toast
